...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Dar de alta Empleado en un Seguro Médico</title>
        <link rel="icon" type="image/x-icon" href="../img/favicon.png">
        <link rel="stylesheet" type="text/css" href="../css/styles.css">
    </head>
    <body>
        <h1>Dar de alta Empleado en un Seguro Médico:</h1>
        <form action="../controlador/ControladorAltaSeguro.php" method="POST">
            <label>Introduzca el NIF del empleado que desea dar de alta:</label>
